...
function Main(): JSX.Element {
  return (
    <main className="bg-secondary-500">
      <section className="md:h-screen about">
        <div
            ...
            <div className="flex items-center w-full h-full">
              <div className="w-full">
                ...
                >
                  ...
                  <p className="px-6 text-2xl md:text-5xl font-bold text-white uppercase">
                ...
                <div className="md:grid md:grid-cols-3 md:gap-4">
                  <div className="p-6 bg-gray-600 bg-opacity-70 rounded mb-4 md:mb-0">
      ...
      <section className="md:h-screen border-t border-secondary-200 team">
        <div className="container h-full mx-auto py-4 px-4">
          <div className="md:flex items-center w-full h-full">
            ...
            <div className="md:flex-auto md:w-1/2">
              <div className="pb-4 mb-4 border-b border-primary-500">
                <h2 className="font-heading text-4xl md:text-6xl font-bold text-gray-400 uppercase">Team</h2>
                <p className="font-heading text-2xl md:text-3xl font-light text-white">
      ...
      <section className="md:h-screen border-t border-secondary-200 clients">
        <div className="container h-full mx-auto py-4 px-4">
          <div className="md:flex md:items-center w-full h-full">
            ...
            <div className="md:flex-auto md:w-1/2 md:order-1">
              <div className="pb-4 mb-4 border-b border-primary-500">
                <h2 className="font-heading text-4xl md:text-6xl font-bold text-gray-400 uppercase">Clients</h2>
                <p className="font-heading text-2xl md:text-3xl font-light text-white">Successful collaborations</p>
              </div>
      ...
      <section className="md:h-screen border-t border-secondary-200 contact-us">
        <div className="container h-full mx-auto py-4 px-4">
          <div className="md:flex md:items-center w-full h-full">
            <div className="w-full">
              <div>
                <h2 className="mb-4 font-heading text-4xl md:text-6xl font-bold text-gray-400 uppercase">Contact Us</h2>
              </div>

              <div className="md:flex w-full">
                <div className="md:flex-auto md:w-1/2">
                  <div className="relative md:fixed left-0 bottom-0 mb-4">
                ...
                <div className="md:flex-auto md:w-1/2">
                  ...
                  <form className="w-full">
                    ...
                    <label className="block w-full block text-secondary-100 uppercase mb-12 md:mb-4" htmlFor="message">
